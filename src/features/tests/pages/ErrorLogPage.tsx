...
const defaultEntries: ErrorLogEntry[] = [
  ...
  },
  {
    ...
    solution: '在正文页章节栏、已发布栏、右侧 AI 面板，以及大纲/脑洞/剧情链/章纲/审核/点评/状态页面的左右区域加入绿色宽度标记，统一显示为“数字PX”。',
    prevention: '新增可拖拽或固定宽度的工作台左右栏时，应同步显示当前宽度，便于后续按视觉反馈继续调参。',
    keywords: ['作品编辑器', '宽度', 'PX', 'AI配置', '左侧栏', 'WorkbenchLibraryPanel', 'ChapterEditor', 'WorkbenchPage'],
    updatedAt: '2026-06-06',
  },
  {
