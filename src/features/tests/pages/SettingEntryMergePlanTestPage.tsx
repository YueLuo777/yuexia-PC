...
const entryPurposeNotes: Record<string, string> = {
  ...
  硬规则: '记录战力、时间、能力边界和世界底层硬约束。',
  禁写规则: '记录不能前后矛盾、不能崩人设、不能跳铺垫和不能滥加设定。',
};
  ...
  },
  {
    ...
    domains: [
      ...
      },
      {
        ...
        beforeCount: 9,
        groups: [
          { name: '硬规则', before: ['战力规则', '时间规则', '能力边界', '世界不可违背规则'], after: ['硬规则'] },
          { name: '禁写规则', before: ['不能前后矛盾', '不能写崩人设', '不能跳过铺垫', '不能破坏爽点承诺', '不能滥加设定'], after: ['禁写规则'] },
        ],
      },
    ],
  },
