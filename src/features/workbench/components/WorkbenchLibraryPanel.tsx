...
export function WorkbenchLibraryPanel({
  ...
  if (
    ...
    const clearPlotPointCandidatePreview = () => {
      setPlotPointGeneratedCandidateText('');
      setIsPlotPointPreviewCleared(true);
      setOutlinePreviewDraft('');
      setExpandedPlotPointPreviewIds([]);
    };
    const regeneratePlotPointCandidates = () => {
      if (isLibraryAiLoading) return;
    ...
    const continuePlotPointCandidates = () => {
      ...
      return (
        <div className="flex min-h-0 flex-1 flex-col bg-white" style={scaleStyle}>
          ...
          >
            ...
            <PlotPointChainWorkspace
              filterMode={plotPointChainFilterMode}
              selectedItems={plotPointSelectedItems}
              visibleSelectedItems={visiblePlotPointSelectedItems}
              writtenIds={plotPointWrittenIdSet}
              activeItemId={activePlotPointChainItemId}
              expandedPreviewIds={expandedPlotPointPreviewIds}
              visibleCandidates={plotPointVisibleCandidates}
              selectedIds={plotPointSelectedIds}
              hasChain={hasPlotPointChain}
              isFollowupStage={isPlotPointFollowupStage}
              isLoading={isLibraryAiLoading}
              leftResizeHandle={plotPointLeftResizeHandle}
              onFilterChange={setPlotPointChainFilterMode}
              onOpenDetailOutline={openDetailOutlineFromPlotPoint}
              onSelectActiveItem={setActivePlotPointChainItemId}
              onTogglePreviewExpanded={togglePlotPointPreviewExpanded}
              onMarkWritten={markPlotPointChainItemWritten}
              onMoveToUnwritten={movePlotPointChainItemToUnwritten}
              onToggleCandidate={togglePlotPointCandidate}
              onClearPreview={clearPlotPointCandidatePreview}
              onRegenerate={regeneratePlotPointCandidates}
              onContinue={continuePlotPointCandidates}
            />
