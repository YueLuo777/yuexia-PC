  ...
  const renderGroup = (
    ...
    >
      <div
        ...
        className={
          group === 'creationFlow'
            ? 'flex min-h-8 w-fit min-w-28 max-w-[calc(15.5em+2rem)] shrink-0 items-center justify-center border-r border-[#dce1e8] px-4 text-center text-[15px] font-black tracking-wide text-[#078FAB]'
