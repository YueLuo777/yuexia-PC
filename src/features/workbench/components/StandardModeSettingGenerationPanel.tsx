    ...
    <div className="flex min-h-0 flex-1 flex-col" data-standard-setting-generation-panel="true">
      ...
      {checkResults === null ? (
        <div className="editor-scrollbar flex min-h-0 flex-1 flex-col overflow-y-auto py-3 pr-1">
          ...
          <label className="mt-4 flex min-h-24 flex-1 flex-col">
            ...
            <textarea
              ...
              className="min-h-24 w-full flex-1 resize-none rounded-md border border-[#BFC8D2] bg-white p-3 text-sm font-medium leading-6 text-[#1f2933] outline-none placeholder:text-xs placeholder:text-[#9aa3af] focus:border-[#08AACE]"
            />
          </label>
