...
export const WORKBENCH_CREATION_FLOW_STEPS: WorkbenchCreationFlowStep[] = [
  ...
  { id: 'audit', number: 6, title: '审核', description: '检查章节问题' },
  { id: 'comment', number: 7, title: '点评', description: '点评章节质量' },
  { id: 'status', number: 8, title: '状态', description: '更新设定状态' },
  { id: 'summary', number: 9, title: '概要', description: '整理章节概要' },
];
