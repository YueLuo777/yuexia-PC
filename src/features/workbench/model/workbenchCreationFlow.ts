...
export const WORKBENCH_REVIEW_FLOW_STEPS: WorkbenchCreationFlowStep[] = [
  ...
  { id: 'status', number: 6, title: '更新状态', description: '更新设定状态', group: 'review' },
  { id: 'summary', number: 7, title: '生成梗概', description: '整理章节梗概', group: 'review' },
  { id: 'polish', number: 8, title: '文笔润色', description: '优化正文表达', group: 'review' },
  { id: 'comment', number: 9, title: '综合点评', description: '点评章节质量', group: 'review' },
];
