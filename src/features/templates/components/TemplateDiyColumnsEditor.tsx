import {
  ...
  DiyEmptyState,
  DiyLevelHeading,
} from './TemplateDiyEditorPrimitives';
import {
  getDiyEntryFields,
...
function SelectableRow({
  ...
  return (
    <div className={`flex min-h-12 items-center gap-2 rounded-md px-2 ${active ? 'bg-[#EAF9FD]' : 'hover:bg-slate-50'}`}>
      <button type="button" aria-label={title} onClick={onSelect} className="min-w-0 flex-1 py-2 text-left">
...
export function TemplateDiyColumnsEditor({
  controller,
}: {
