...
export const AiInlineInput = forwardRef<HTMLTextAreaElement, AiInlineInputProps>(function AiInlineInput(
  ...
  return (
    <div
      ...
      className={`xy-floating-field xy-floating-ai xy-floating-compact xy-floating-with-inline-actions ${variantClassName} ${value.trim() ? 'xy-has-value' : ''} ${className}`.trim()}
    >
      <textarea
        data-no-modal-drag="true"
        ref={ref}
